  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-5">
        ...
        {/* Right Panel — Password & Create Admin */}
        <div className="flex-1 min-w-0 space-y-4">
          ...
          {/* Create Super Admin Card — Disabled */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden opacity-50 cursor-not-allowed">
